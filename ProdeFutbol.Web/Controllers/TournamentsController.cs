...
namespace ProdeFutbol.Web.Controllers
{
    ...
    public class TournamentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            TournamentEntity tournamentEntity = await _context.Tournaments
                .Include(t => t.Groups)//Si la relacion es de 1er nivel, se utiliza .Include
                .ThenInclude(t => t.Matches)//Si la relacion es de 2do nivel o mas, se utiliza .ThenInclude
